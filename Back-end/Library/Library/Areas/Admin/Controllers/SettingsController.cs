...
namespace Library.Areas.Admin.Controllers
{
    ...
    public class SettingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Adress,Email,Phone,Info")] Setting setting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Adress,Email,Phone,Info")] Setting setting)
        {
            if (ModelState.IsValid)
            {
